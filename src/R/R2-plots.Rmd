---
title: "GBU Plots-recommendations"
output:
  pdf_document:
    toc: yes
    toc_depth: 4
...
r %>% update_model_names %>% ggplot(aes(x = model, y = avg, 
  ...
  facet_wrap(~"Within-task improvement of the HMM framework over alternative recommenders",strip.position = "top")
}
```
...
## Figure XX: Performance within openings
...
\newpage
## Figure XX: AUC comparison -- many assessment
